...
const { EMAIL_VERIFY__TEMPLATE, PASSWORD_RESET_TEMPLATE } = require("../config/emailTemplate");
...
const register = async (req, res)=>{
    ...
    try {
        ...
        const mailOptions = {
            ...
            to: email,
            subject: 'Welcome to RTS',
            text: `Welcome to this Website. Account created with this email: ${email}`
        }
...
const sendVerifyOtp = async (req, res) => {
    try {
        ...
        const mailOption = {
            ...
            //  html: EMAIL_VERIFY__TEMPLATE.replace("{{otp}}", otp).replace("{{email}}",user.email)
            html: EMAIL_VERIFY__TEMPLATE.replace("{{otp}}", otp).replace("{{email}}",user.email)
        };
